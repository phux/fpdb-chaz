...
class Stat:
    def __init__(self, node):
        ...
        self.stat_midloth = node.getAttribute("stat_midloth")
        self.stat_midhith = node.getAttribute("stat_midhith")
        self.stat_hith = node.getAttribute("stat_hith")
        self.stat_locolor = node.getAttribute("stat_locolor")
        self.stat_midlocolor = node.getAttribute("stat_midlocolor")
        self.stat_midhicolor = node.getAttribute("stat_midhicolor")
